...
<div class="header">
  <div class="row">
    ...
    <div class="col-3 col-s-3">
      ...
      <div class="" style="">
      <a  style="font-size: 15px;color: grey;margin-right: 10px;cursor: pointer;" 
      onclick="document.getElementById('id02').style.display='block'">ĐĂNG KÍ</a>
